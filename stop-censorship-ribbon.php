...
function render_stop_censorship_ribbon() {
	...
	echo "<a target='_blank' class='stop-censorship-ribbon' href='http://cyberspying.eff.org/'><img src='{$ribbon_url}' alt='Stop censorship' style='position: fixed; top: ".$padding_top ."px; right: 0; z-index: 100000; cursor: pointer; border:none;' /></a>";
}
